<?php
    ...
    $id_get = $_GET['id'];
    $query_data_akun = mysqli_query($koneksi, "SELECT * FROM user WHERE id='$id_get'");
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-6 wow fadeInUp">
                    ...
                    <div class="text-lg">
                        <form method="POST" action="function/edit_akun.php">
                            <input type="hidden" name="id" value="<?php echo $data_akun['id']; ?>">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Nama</label>
                                <input type="text" class="form-control" name="nama" placeholder="Nama" value="<?php echo $data_akun['nama']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Username</label>
                                <input type="hidden" class="form-control" name="username_lama" placeholder="Username" value="<?php echo $data_akun['username']; ?>">
